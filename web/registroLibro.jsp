<%-- 
    ...
    Created on : 03/05/2018, 12:30:22 AM
    Author     : Martín
--%>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div>
                                            <!-- action="EditorialControl -> Corresponde a la clase java servlet ubicada en controller" -->
                                            <form action="LibroControl" method="POST" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nombreAutor" value="" placeholder="Nombre del autor" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-rigth">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" name="publicacion" value="" placeholder="yyyy-mm-dd"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-rigth">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name="descripcion" maxlength="255"></textarea>
                                                    </div>
                                                </div>      
