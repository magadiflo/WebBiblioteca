...
public class Libro implements Serializable{
    ...
    public Libro(String isbn, String titulo, String descripcion, 
            String nombreAutor, String publicacion, String fechaRegistro, 
            int codigoCategoria, String nitEditorial) {
        this.isbn = isbn;
        this.titulo = titulo;
